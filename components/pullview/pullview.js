...
export default class PullView extends PureComponent {
    ...
    componentDidMount() {
        const container = document.body; // pull的对象
        const { props: { mountScrollTop } } = this;
    ...
    componentWillUnmount() {
        const container = document.body; // pull的对象
        const { props: { onPullViewUnmount } } = this;
    ...
    _onScroll() {
        const container = document.body; // pull的对象
        const { props: { toBottom, onScrollToBottom, onScrollUp, onScrollDown } } = this;
