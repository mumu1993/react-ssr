...
const checkOverflowVisible = function checkOverflowVisible(component, parent) {
    ...
    const offsets = Array.isArray(component.props.offset) ?
        component.props.offset : [component.props.offset, component.props.offset]; // Be compatible with previous API
...
class LazyLoad extends Component {
    ...
    render() {
        return this.visible ?
            ...
            this.props.placeholder :
            <div style={{ width: this.props.width, height: this.props.height }} className="lazyload-placeholder" />;
    }
}
